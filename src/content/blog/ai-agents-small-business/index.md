...
McKinsey estimated that generative AI could add [$2.6 trillion to $4.4 trillion in annual economic value](https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier), but the useful part for founders is not the giant number. It is where the value sits: customer operations, sales, software engineering, and knowledge work. That matches what I see in the field.
...
The same applies to SEO and LLM optimization. If an answer engine is going to cite you, it needs clear claims, named entities, dates, and sources. Harvard Business Review reported that people use generative AI heavily for practical support, including tutoring, organizing life, and work tasks, in its piece on [how people are really using generative AI](https://hbr.org/2024/03/how-people-are-really-using-gen-ai). That is the kind of external support a founder can reference, not just repeat.
...
For deeper app-building notes, I keep the live story here: [how I built two iOS apps without coding](/news/how-i-built-2-ios-apps-without-coding/). Both apps — RunMate Pro and SunUp by GearTOP — are public, and I break down how each one was built on the [projects page](/projects/). Real shipping teaches lessons that demos do not.
...
Gartner has predicted that by 2028, [agentic AI will autonomously resolve a large share of common customer service issues](https://www.gartner.com/en/newsroom/press-releases/2024-10-21-gartner-predicts-agentic-ai-will-autonomously-resolve-80-percent-of-common-customer-service-issues-without-human-intervention-by-2029). I would still keep a human in the loop for refunds, cancellations, health claims, and angry customers. Speed without judgment is how small businesses create expensive messes.
...
Andreessen Horowitz tracks consumer AI usage in its [Top 100 Gen AI Consumer Apps](https://a16z.com/100-gen-ai-apps/), and one lesson is obvious: user behavior shifts fast. Your small business site should not chase every tool, but it should publish pages that make your expertise machine-readable and useful to a real buyer.
...
For my own site, I connect this article to [how I built two iOS apps without coding](/news/how-i-built-2-ios-apps-without-coding/), [how I replaced agency costs with AI](/news/how-i-replaced-agency-costs-with-ai/), [my AI blog writing workflow](/news/ai-blog-writing-workflow/), and the [projects page](/projects/). Those links tell both readers and answer engines what the site is actually about.
